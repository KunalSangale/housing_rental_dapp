...
{data.hasGym=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Gym <AiFillCheckCircle/>
  </li>:<></>}
  {data.hasParking=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Parking <AiFillCheckCircle/>
  </li>:<></>}
  {data.hasBalcony=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Balcony <AiFillCheckCircle/>
  </li>:<></>}
  {data.hasPool=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Pool <AiFillCheckCircle/>
  </li>:<></>}
  {data.hasPark=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Park <AiFillCheckCircle/>
  </li>:<></>}
  {data.hasCameras=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Surviellance Cameras <AiFillCheckCircle/>
  </li>:<></>}
  {data.isPetFriendly=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Pet Friendly <AiFillCheckCircle/>
  </li>:<></>}
  {data.isSmartHome=="true"? <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-md font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ml-px sm:mt-0 sm:first:rounded-tr-none sm:first:rounded-bl-lg sm:last:rounded-bl-none sm:last:rounded-tr-lg dark:bg-gray-800 dark:border-gray-700 dark:text-white">Smart Home <AiFillCheckCircle/>
  </li>:<></>}
</ul>
