        ...
        <form class="flex flex-col w-full md:px-32 mt-32" onSubmit={handleSubmit}>
            <div class="flex flex-wrap -mx-3 mb-6 mt-100px">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500"
                        type="text"
                        name="propertyID"
            ...
            <div class="md:flex md:items-center">
                <div class="md:w-2/3">
                    <button
                        class="bg-blue-500 h-fit px-8 py-2 text-sm text-white font-nunito rounded-md font-bold"
                        type="submit"
                    >
                        Submit
                    </button>
